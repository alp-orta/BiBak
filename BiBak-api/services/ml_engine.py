...
RISK_FLAG_MAP = {
    "tr": {
        ...
        "limited_seller_history": "BiBak satıcı geçmişi az",
        "missing_marketplace_seller_score": "Satıcı puanı okunamadı",
        "weak_seller_identity": "Satıcı kimliği eksik",
        "limited_fulfillment_signals": "Teslimat sinyali az",
        "limited_marketplace_traction": "Satıcı görünürlüğü sınırlı",
    ...
    "en": {
        ...
        "limited_seller_history": "BiBak has little seller history",
        "missing_marketplace_seller_score": "Seller rating could not be read",
        "weak_seller_identity": "Seller identity is incomplete",
        "limited_fulfillment_signals": "Fulfillment signals are limited",
        "limited_marketplace_traction": "Seller marketplace traction is limited",
...
def _append_contextual_flags(risk_flags: list[str], warnings: list[str], locale: str) -> list[str]:
    ...
    additions = {
        ...
        "missing_marketplace_seller_score": "missing_marketplace_seller_score",
        "low_marketplace_seller_score": "seller_review_risk",
        "weak_seller_identity": "weak_seller_identity",
        "limited_fulfillment_signals": "limited_fulfillment_signals",
        "limited_marketplace_traction": "limited_marketplace_traction",
